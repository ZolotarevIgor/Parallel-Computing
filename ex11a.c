...
int main(int argc, char *argv[])
{
  /*
    ...
    ncm - nc - 1. Нужно как граница циклов
    ncp -
    ncx -
  */
  ...
  hx -
  hx2 - hx ^ 2
  Остальные переменные либо описаны дальше, либо лишком специфичны для этого ex, поэтому не стал разбирать их досконально.
  */
